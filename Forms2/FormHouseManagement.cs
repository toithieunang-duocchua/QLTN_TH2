...
namespace QLTN.Forms
{
    public partial class FormHouseManagement : Form
    {
        ...
        private void AdjustPanelHeights()
        {
            ...
            // Update House B position
            panelHouseB.Location = new Point(0, panelHouseA.Height + 60); // 60px for header
        }

        private int CalculateRequiredHeight(Label label)
        {
        ...
        private void LoadFormRoom(string houseName, string houseAddress)
        {
            ...
            if (mainForm != null)
            {
                // Tạo FormRoom và set TopLevel = false để có thể load vào panel
        ...
        {
            // Placeholder for subtitle click event
        }

        private void panelContent_Paint(object sender, PaintEventArgs e)
        {
            // Add subtle border to content panel
