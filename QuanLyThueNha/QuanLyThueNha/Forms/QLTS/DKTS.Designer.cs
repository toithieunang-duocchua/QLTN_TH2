namespace QuanLyThueNha.Forms
{
    partial class DKTS
    {
        ...
        private void InitializeComponent()
        {
            ...
            btn_id = new DataGridViewTextBoxColumn();
            btn_toanha = new DataGridViewTextBoxColumn();
            btn_diachi = new DataGridViewTextBoxColumn();
            btn_tongSoPhong = new DataGridViewTextBoxColumn();
            btn_ngayTao = new DataGridViewTextBoxColumn();
            btn_ghiChu = new DataGridViewTextBoxColumn();
            ...
            // btn_xacnhan
            // 
            btn_xacnhan.Location = new Point(629, 263);
            ...
            dataGridView1.Columns.AddRange(new DataGridViewColumn[] { btn_id, btn_toanha, btn_diachi, btn_tongSoPhong, btn_ngayTao, btn_ghiChu });
            ...
            // btn_id
            // 
            btn_id.HeaderText = "ID";
            btn_id.MinimumWidth = 6;
            btn_id.Name = "btn_id";
            btn_id.Width = 125;
            // 
            // btn_toanha
            // 
            btn_toanha.HeaderText = "Tòa nhà";
            btn_toanha.MinimumWidth = 6;
            btn_toanha.Name = "btn_toanha";
            btn_toanha.Width = 125;
            // 
            // btn_diachi
            // 
            btn_diachi.HeaderText = "Địa chỉ";
            btn_diachi.MinimumWidth = 6;
            btn_diachi.Name = "btn_diachi";
            btn_diachi.Width = 125;
            // 
            // btn_tongSoPhong
            // 
            btn_tongSoPhong.HeaderText = "Tổng số phòng";
            btn_tongSoPhong.MinimumWidth = 6;
            btn_tongSoPhong.Name = "btn_tongSoPhong";
            btn_tongSoPhong.Width = 125;
            // 
            // btn_ngayTao
            // 
            btn_ngayTao.HeaderText = "Ngày tạo";
            btn_ngayTao.MinimumWidth = 6;
            btn_ngayTao.Name = "btn_ngayTao";
            btn_ngayTao.Width = 125;
            // 
            // btn_ghiChu
            // 
            btn_ghiChu.HeaderText = "Ghi Chú";
            btn_ghiChu.MinimumWidth = 6;
            btn_ghiChu.Name = "btn_ghiChu";
            btn_ghiChu.Width = 125;
            // 
            // DKTS
            // 
        ...
        private DataGridViewTextBoxColumn btn_id;
        private DataGridViewTextBoxColumn btn_toanha;
        private DataGridViewTextBoxColumn btn_diachi;
        private DataGridViewTextBoxColumn btn_tongSoPhong;
        private DataGridViewTextBoxColumn btn_ngayTao;
        private DataGridViewTextBoxColumn btn_ghiChu;
    }
}